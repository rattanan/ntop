...
export const helpArticles: HelpArticle[] = [
  ...
  },
  {
    ...
    relatedSlugs: ["lead-qualification-and-conversion", "sales-pipeline-and-forecast", "presales-solution-survey-boq"],
  },
  {
  ...
  },
  {
    ...
    relatedSlugs: ["customer-to-opportunity", "notifications-and-tasks", "quotation-and-approval"],
  },
  {
  ...
  },
  {
    ...
    sections: [
      ...
      { title: "AI Generator", body: ["AI ใช้ Opportunity, Customer, Meeting Notes, Template และ Product ที่เลือกภายใน scope แล้วสร้าง editable Draft", "ต้องตรวจข้อเท็จจริง ราคา ขอบเขตและเงื่อนไข; provider outage ยังแก้ manual ได้"] },
  ...
  },
  {
    ...
    relatedSlugs: ["quotation-and-approval", "contract-to-service-order", "ai-assistance-and-safety"],
  },
];
