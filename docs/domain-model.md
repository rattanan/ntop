...
| Open Decisions | Account hierarchy cardinality; detailed document classification (customer merge authority and approval thresholds are approved) |
...
- **Customer:** stable `customerId`; status, segment และ active owner; external ID unique ภายใน source; hierarchy ห้ามเกิด cycle; duplicate candidates use deterministic/scored matching; Data Steward-approved merge ต้องเก็บ aliases/history/audit และ cross-unit conflict escalate ไป Customer Data Owner (FR-001, DATA-001)
