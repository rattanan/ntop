...
| Metadata | Value |
|---|---|
| Status | Approved — OD-001 to OD-006 Closed |
| Version | 1.0 |
...
|---|---|---|---|---|---|---|---|
| OD-001 | อนุมัติ Customer Data Owner, canonical identifiers, duplicate/merge และ stewardship | Data Governance Lead | 2026-07-11 | BR-001, FR-001, DATA-001/003; R-02, R-07 | Approved | Central governance + governed merge | Project owner confirmation |
| OD-002 | อนุมัติ classification, retention, masking, export, deletion และ legal hold | Data Governance + Security | 2026-07-11 | COMP-002, SEC-003, DATA-001/003; R-04, R-07 | Approved | 7y commercial / 3y activity / 1y security logs | Project owner confirmation |
| OD-003 | อนุมัติ commercial thresholds, authority, SoD, delegation, SLA และ legal triggers | Pricing/Commercial Owner | 2026-07-11 | BR-004, FR-006/007, SEC-002, COMP-001; R-08 | Approved | 3 tiers + risk exceptions | Project owner confirmation |
| OD-004 | เลือก 1–2 integrations และอนุมัติ field-level source of truth/owners/fallback | Integration Governance | 2026-07-11 | BR-005, INT-001–004; R-06, R-11 | Approved | No live integration year one; manual fallback | Project owner confirmation |
| OD-005 | ยืนยัน availability, RPO/RTO, backup, DR topology และ exercise | IT Operations | 2026-07-11 | NFR-003, OPS-001/003/004; R-13 | Approved | 99.9%, RPO15, RTO4, quarterly restore | Project owner confirmation |
| OD-006 | อนุมัติ pilot division, users, data volume, adoption KPIs และ rollback | Sales Sponsor | 2026-07-11 | BR-002/003, NFR-002; R-12, R-15 | Approved | One division, 75 named users, 4+2 weeks | Project owner confirmation |
...
- **Approval scope:** OD-001 through OD-006 exactly as recorded in Provisional Baseline Simulation 0.1
- **Approval source:** explicit project owner confirmation in the Codex task (“อนุมัติแล้ว” and confirmation that all six decisions are approved unchanged)
- **Baseline result:** Approved Baseline 1.0
- **Named signatures:** not supplied; no personal names or signatures are fabricated
- **Administrative follow-up:** attach organizational Steering Committee signature references when available without changing the decision effective date
