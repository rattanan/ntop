...
export default async function OpportunityDetail({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <>
    ...
    <nav className="opportunity-tabs" aria-label="ส่วนข้อมูล Opportunity"><a href="#overview">Overview</a><a href="#health">Health</a><a href="#requirements">Requirements</a><a href="#stakeholders">Stakeholders</a><a href="#competitors">Competitors</a><a href="#timeline">Timeline</a></nav>
