...
export default async function ProposalDetailPage({params}:{params:Promise<{id:string}>}){
  ...
  const canManage=permissionPolicy.allows(session,PERMISSIONS.proposalManage);const canEdit=canManage;const latest=proposal.versions[0];
