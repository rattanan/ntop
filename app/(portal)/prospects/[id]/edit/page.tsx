...
export default async function EditProspectPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const values = {
    ...
    branchNumber: prospect.branchNumber ?? undefined, customerType: prospect.customerType ?? undefined,
    organizationType: prospect.organizationType ?? undefined, subIndustry: prospect.subIndustry ?? undefined,
    companySize: prospect.companySize ?? undefined, numberOfEmployees: prospect.numberOfEmployees ?? undefined,
