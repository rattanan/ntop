-- Additive MySQL 8 migration for human-readable Opportunity numbers and
-- auditable probability overrides. Existing rows remain valid during backfill.
...
CREATE TABLE `OpportunityProbabilityHistory` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `OpportunityProbabilityHistory_opportunity_version_key` (`opportunityId`,`aggregateVersion`),
  INDEX `OpportunityProbabilityHistory_opportunity_time_idx` (`opportunityId`,`changedAt`),
